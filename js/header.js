window.opon = function (url) {
    url = appendParam(url, 'from', '123.YongAn.org')
    window.open(url)
}
...
function search() {
                ...
                if (hotList) {
                    ...
                    for (var i = 0; i < hotList; i++) {
                        ...
                        $("#box ul li").eq(i).click(function () {
                            ...
                            $("#txt").val(thisText);
                            window.opon(searchData.thisSearch + thisText);
    ...
    $("#txt").keydown(function (e) {
        ...
        if (e.keyCode === 13) {
            window.opon(searchData.thisSearch + $("#txt").val());
            $("#box").css("display", "none");
            $("#txt").blur();
    ...
    $("#search-btn").click(function () {
        ...
        if (textValue) {
            window.opon(searchData.thisSearch + textValue);
            $("#box ul").html("")
        } else {
            layer.msg("请输入关键词！", {
                time: 500
